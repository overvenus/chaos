...
// 	ops, err := history.ReadHistory(historyFile, bankParser{})
// 	if err != nil {
// 		return nil, err
// 	}
// 	ops, err = history.CompleteOperations(ops, bankParser{})
// 	if err != nil {
// 		return nil, err
// 	}
// 	events, err := check.ConvertOperationsToEvents(ops)
// 	if err != nil {
// 		return nil, err
// 	}
...
func (bankTsoChecker) String() string {
